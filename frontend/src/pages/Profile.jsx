...
const BASE_URL = "https://expense-manager-backend-lhq1.onrender.com/api";
...
const Profile = ({ onUpdateProfile, onLogout }) => {
    ...
    const handleApiRequest = useCallback(async (endpoint, method, data = null) => {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            ...
            try {
                ...
                const response = await handleApiRequest("/user/me", "get");
    ...
    // Input change handler for updating tempUser state
    ...
    const handleSaveProfile = async () => {
        try {
            const response = await handleApiRequest("/user/profile", "put", tempUser);
            if (response) {
    ...
    const handlePasswordSubmit  = async (e) => {
        ...
        try {
            await handleApiRequest("/user/password", "put", {
