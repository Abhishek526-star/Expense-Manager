...
import { getTimeFrameRange, calculateData, getPreviousTimeFrameRange } from '../components/Helper'
...
// to conver date to ISO timeline 
...
const Dashboard = () => {
  ...
  // Function to check if a transaction's date is within the current time frame
  ...
  // Filter transactions based on the current time frame
  ...
  // Calculate the data for the current time frame
  ...
  // Update the gauge data based on the current time frame
  useEffect(() => {
    const maxValues = {
  ...
  }, [filteredTransactions, timeFrame, overviewMeta]);
...
// console.log("Daily Transactions:", filteredTransactions);
// console.log("Income:", currentTimeFrameData.income);
// console.log("Expense:", currentTimeFrameData.expenses);
// console.log("Savings:", currentTimeFrameData.savings);
          ...
          additionalContent={
            <div className={`mt-2 text-xs flex items-center gap-1 ${expenseChange >= 0 ? trendStyles.positive : trendStyles.negative
              ...
              <span>
                ...
                {expenseChange >= 0 ? "increases" : "Decreases"} from{" "}
          ...
          additionalContent={
            <div className="mt-2 text-xs text-cyan-600 flex items-center gap-2">
              <div className="flex items-center gap-1">
                ...
                <span>
                  {displayIncome > 0 ? Math.round((
                    displaySavings / displayIncome
                  ) * 100) : 0}% of Income
                </span>
              </div>
